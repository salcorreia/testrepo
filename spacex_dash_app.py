...
def get_pie_chart(entered_site):
    ...
    # return the outcomes piechart for a selected site
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]['class'].value_counts().to_frame().sort_index().reset_index()
        fig = px.pie(filtered_df, values='class', 
        names='index', 
        title='Total Success Launches for site '+entered_site,
        color='index', color_discrete_sequence=('red','blue'))
        return fig
# TASK 4:
